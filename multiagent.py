...
1. rag_search  : Use FIRST for any question about the company, its policies,
                 products, pricing, reports, support, or internal documents.
                 Keywords that trigger rag_search: 'company', 'policy', 'refund',
                 'product', 'price', 'report', 'revenue', 'support', 'contact'.
2. web_search  : Use for current events, news, or general internet knowledge
                 that is NOT about internal company documents.
3. calculator  : Use ONLY for math or arithmetic expressions.

IMPORTANT: Never output 'Action: None'. Always pick one of the three tools above.
...
Thought: decide which tool to use based on the rules above
